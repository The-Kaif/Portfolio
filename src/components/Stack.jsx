  ...
  return (
    ...
    >
      ...
      <div class="main-stack">
        <div data-aos="fade-down" className="stack-column">
          ...
          <div className="d-flex align-items-center justify-content-center">
            <p className="lead fs-6 fw-lighter text-center">
              Proficient in React, TypeScript, Redux, Bootstrap, ANTD, MUI, REST
              API. Familiar with Next.js, GraphQL for advanced web development
              and optimal user experiences.
            </p>
          </div>
        </div>

        <div className="stack-column" data-aos="fade-up">
          <div className="d-flex align-items-center justify-content-center">
        ...
        <div className="stack-column" data-aos="fade-down">
          <div className="d-flex align-items-center justify-content-center">
